        ...
        <footer className="footer">
            <div className="container">
                    ...
                    <div className="c-footer">
                        <div className="layout">
                            ...
                            <div className="layout_item w-50">
                                <p>Images by <a style={{ color: '#0000EE' }} href="https://www.freepik.com/free-photo/shirt-mockup-concept-with-plain-clothing_27828417.htm#page=5&query=t%20shirt%20mockup&position=41&from_view=search&track=ais&uuid=a685ff1c-fe84-4b29-8dd5-540e0ea07241" target="_blank">Freepik1</a>, <a style={{ color: '#0000EE' }} href="https://www.freepik.com/free-photo/shirt-mockup-concept-with-plain-clothing_27828397.htm#query=background%20t%20shirt&position=16&from_view=keyword&track=ais&uuid=d1121ef4-f680-498c-87d3-6d63bfad2a58">Freepik2</a></p>
                        ...
                        <div className="layout c-2">
                            ...
                            <div className="layout_item w-25">
                                <ul className="flex">
                                    <li>
                                        {/* https://www.linkedin.com/in/muhammad-ahmed-550ab0288/ */}
                                    ...
                                    <li>
                                        {/* https://www.fiverr.com/editsbyahmed */}
                                        <a href="" target='_blank'>
                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 30 30">
                                    ...
                                    <li>
                                        {/* https://github.com/MuhammadAhmed120 */}
                                        <a href="" target='_blank'>
                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 30 30">
                ...
                <div className="footer_copyright">
                    {/* https://www.fiverr.com/editsbyahmed */}
                    <p>Made by <a href="" target="_blank">Muhammad Ahmed</a>,  Image by <a href="https://www.freepik.com/free-photo/shirt-mockup-concept-with-plain-clothing_27828417.htm#page=5&query=t%20shirt%20mockup&position=41&from_view=search&track=ais&uuid=a685ff1c-fe84-4b29-8dd5-540e0ea07241" target="_blank">Freepik</a></p>
                </div>
            </div>
        </footer >
    )
